...
const char* ssid     = "Lexus";
const char* password = "Wifi Password"; //Cannot be revealed
//chatgpt api
const char* chatgpt_token = "ChatGPT API"; //Cannot be revealed

//chat completions endpoint
char chatgpt_server[] = "https://api.openai.com/v1/chat/completions";
...
void loop()
{
  switch(currentState){
    ...
    // Use "messages" + a chat model
    String payload = String("{")
        + "\"model\":\"gpt-3.5-turbo\","
        + "\"messages\":["
            + "{\"role\":\"user\",\"content\":\"" + chatgpt_Q + "\"}"
        + "],"
        + "\"temperature\":0,"
        + "\"max_tokens\":100"
        + "}";
